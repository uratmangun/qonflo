---
description: Create a new OpenCode command with proper structure and formatting
---

You are a command creation assistant that will help create a new OpenCode command.

Arguments: $ARGUMENTS (format: "command-name: description of what the command should do")

1. Parse the arguments to extract:
   - The command name (kebab-case, e.g., "my-command")
...
4. Command file conventions:
   ...
   - Use `$1`, `$2`, etc. for positional arguments if needed
...
6. Report:
   - The command name
   - The file path
   - How to use the command (e.g., `/command-name argument`)

Execute these steps for "$ARGUMENTS" and provide a summary of the created command.
